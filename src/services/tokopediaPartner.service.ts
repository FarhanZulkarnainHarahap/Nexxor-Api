...
export class TokopediaPartnerService implements MarketplaceAdapter {
  private unavailable(): never {
    // TODO(partner-api): Implement only from approved Tokopedia Partner Center
    // documentation after credentials, scopes, signing rules, and endpoints are issued.
    throw new Error(
      "Tokopedia live adapter requires official Partner Center documentation and credentials",
    );
  }
